...
<div class="container">
    <section class="page_content mb-5">
        ...
        <a id="exportDataToCsv" class="btn btn-primary psgdprgetdatabtn17 mt-2 mr-0" target="_blank" href="{$psgdpr_csv_controller|escape:'htmlall':'UTF-8'}">{l s='GET MY DATA TO CSV' mod='psgdpr'}</a>
        <a id="exportDataToPdf" class="btn btn-primary psgdprgetdatabtn17 mt-2" target="_blank" href="{$psgdpr_pdf_controller|escape:'htmlall':'UTF-8'}">{l s='GET MY DATA TO PDF' mod='psgdpr'}</a>
    </section>
</div>
{literal}
