        ...
        <form action="{$urls.pages.contact}" method="post" {if $contact.allow_file_upload}enctype="multipart/form-data" {/if}>
            ...
            <section class="form-fields">
                ...
                <div class="form-group message">
                    ...
                    <div>
                        <textarea class="form-control" name="message" placeholder="{l s='How can we help?' d='Shop.Forms.Help'}" rows="3">{if $contact.message}{$contact.message}{/if}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group email ">
                    ...
                    <div>
                        <input class="form-control email" name="from" type="email" value="{$contact.email}" placeholder="{l s='your@email.com' d='Shop.Forms.Help'}">
                    </div>
                </div>
