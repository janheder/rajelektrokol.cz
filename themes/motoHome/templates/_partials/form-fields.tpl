    ...
    <div class="form-group row {if !empty($field.errors)}has-error{/if}">
        ...
        <div class="col-md-6{if ($field.type === 'radio-buttons')} form-control-valign{/if}">
            ...
            <div class="input-group">
                <input class="form-control js-visible-password" name="{$field.name}" type="password" value="" pattern=".{literal}{{/literal}5,{literal}}{/literal}" {if $field.required}required{/if}>
