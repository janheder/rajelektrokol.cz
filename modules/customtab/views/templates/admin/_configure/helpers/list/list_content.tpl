...
{block name="td_content"}
    {if isset($params.type) && $params.type == 'block_image'}
        ...
        {if isset($id_image['id_image']) && $id_image['id_image']}
            <img src="{$base_dir|escape:'htmlall':'UTF-8'}{$link->getImageLink($tr.link_rewrite, $id_image['id_image'], 'cart_default')|escape:'htmlall':'UTF-8'}" class="img-thumbnail img-thumbnail-tab" />
        {else}
