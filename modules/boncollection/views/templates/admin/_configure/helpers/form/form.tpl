...
{block name="field"}
                        ...
                        <div class="dummyfile input-group">
                            ...
                            <span class="input-group-btn">
                                <button
                                    ...
                                    {l s='Choose a file' mod='boncollection'}
                                </button>
                            </span>
                        </div>
                        {if $input.type == 'files_lang_sub'}
                            {if $fields_value.type == 'image'}
                                ...
                                {/if}
                            {/if}
                            {if $fields_value.type == 'video'}
                                {if isset($fields[0]['form']['images'][$language.id_lang|escape:'htmlall':'UTF-8']) && $fields[0]['form']['images'][$language.id_lang|escape:'htmlall':'UTF-8']}
                                    <img src="{$image_baseurl_video|escape:'htmlall':'UTF-8'}video.png" class="img-parallax" />
                                {/if}
                            {/if}
                        {else}
                            {if isset($fields[0]['form']['images'][$language.id_lang|escape:'htmlall':'UTF-8']) && $fields[0]['form']['images'][$language.id_lang|escape:'htmlall':'UTF-8']}
    ...
    {/if}
    {if $input.type == 'files_lang_cover' }
        <div class="row bonmp-files-upload">
            {foreach from=$languages item=language}
                {if $languages|count > 1}
                    <div class="translatable-field lang-{$language.id_lang|escape:'htmlall':'UTF-8'}"
                    ...
                    <div class="col-lg-6">
                        ...
                        {if $fields_value.type == 'video'}
                            {if isset($fields[0]['form']['cover'][$language.id_lang|escape:'htmlall':'UTF-8']) && $fields[0]['form']['cover'][$language.id_lang|escape:'htmlall':'UTF-8']}
                                <img src="{$image_baseurl|escape:'htmlall':'UTF-8'}{$fields[0]['form']['cover'][$language.id_lang|escape:'htmlall':'UTF-8']}"
                                    class="img-thumbnail" />
                            {/if}
                        {/if}
                    </div>
    ...
    {/if}
    {if $input.type == 'files_lang_author' }
        <div class="row bonmp-files-upload">
            {foreach from=$languages item=language}
                {if $languages|count > 1}
                    <div class="translatable-field lang-{$language.id_lang|escape:'htmlall':'UTF-8'}"
                    ...
                    <div class="col-lg-6">
                        ...
                        {if isset($fields[0]['form']['author_img'][$language.id_lang|escape:'htmlall':'UTF-8']) && $fields[0]['form']['author_img'][$language.id_lang|escape:'htmlall':'UTF-8']}
                            <img style="width: 54px; height: 54px"
                                src="{$image_baseurl|escape:'htmlall':'UTF-8'}{$fields[0]['form']['author_img'][$language.id_lang|escape:'htmlall':'UTF-8']}"
                                class="img-thumbnail" />
                        {/if}
                    </div>
                    {if $languages|count > 1}
