    ...
    {if $input.name == "id_tab"}
        ...
        {else}
            <div class="bonimage-container col-lg-12" style="border: none;" data-width="" data-height="">
                <p class="bonlookbookfw-info"><img src="{$image_baseurl|escape:'htmlall':'UTF-8'}label-warning.svg" alt="label-warning">{l s='Please add an image to the parent element so that you can mark a point on the image.' mod='bonlookbookfw'}</p>
                        ...
                        <div class="dummyfile input-group">
                            ...
                            <span class="input-group-btn">
                                <button
                                    ...
                                    {l s='Choose a file' mod='bonlookbookfw'}
                                </button>
                            </span>
                        </div>
                        {if $input.name|escape:'htmlall':'UTF-8' == "image"}
                            <p>{l s='Format file .png, .jpg, .gif.' mod='bonlookbookfw'}</p>
                            {if isset($fields[0]['form']['images']) && $fields[0]['form']['images']}
