...
class BonlookbookfwMainModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        foreach ($tabs as $key => $tab) {
            ...
            if (file_exists($_SERVER["DOCUMENT_ROOT"] . _MODULE_DIR_  . 'bonlookbookfw/views/img/' . $tab['image'])) {
                $result[$key]['image_size'] = getimagesize($_SERVER["DOCUMENT_ROOT"] . _MODULE_DIR_  . 'bonlookbookfw/views/img/' . $tab['image']);
            }
        ...
        $this->context->smarty->assign(array(
            'items'=> $result,
            'points'=> $points,
            'image_baseurl'=> _MODULE_DIR_ . 'bonlookbookfw/views/img/'
        ));

        $this->setTemplate('module:bonlookbookfw/views/templates/hook/bonlookbookfw.tpl');
    }
