...
require_once(dirname(__FILE__).'/BonCommentCriterion.php');

if (empty(Tools::getValue('id_lang')) === false && Tools::getValue('id_product') === true) {
	$criterions = BonCommentCriterion::get(Tools::getValue('id_lang'));
	if ((int)(Tools::getValue('id_product'))) {
        $selects = BonCommentCriterion::getByProduct(Tools::getValue('id_product'), Tools::getValue('id_lang'));
    }
