                        ...
                        <div class="dummyfile input-group">
                            ...
                            <span class="input-group-btn">
                                <button id="{$input.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|escape:'htmlall':'UTF-8'}-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
                                    ...
                                    {l s='Choose a file' mod='boninfoban'}
                                </button>
                            </span>
                        </div>
        ...
        <div class="row bonmp-files-upload">
            ...
            {if $fields_value.type == 'video'}
                        ...
                        {if isset($fields[0]['form']['cover'][$language.id_lang|escape:'htmlall':'UTF-8']) && $fields[0]['form']['cover'][$language.id_lang|escape:'htmlall':'UTF-8']}
                            <img src="{$image_baseurl|escape:'htmlall':'UTF-8'}{$fields[0]['form']['cover'][$language.id_lang|escape:'htmlall':'UTF-8']}" class="img-thumbnail" />
                        {/if}
                    {/if}
                    </div>
                    {if $languages|count > 1}
