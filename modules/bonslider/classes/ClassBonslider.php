...
class ClassBonslider extends ObjectModel
{
    public $id_tab;
    public $id_shop;
    public $title;
    ...
    public static function getBonsliderCategoryList()
    {
        $sql = 'SELECT bons.*, bonsl.`title`, bonsl.`url`, bonsl.`image`
                FROM ' . _DB_PREFIX_ . 'bonslider bons
                JOIN ' . _DB_PREFIX_ . 'bonslider_lang bonsl
