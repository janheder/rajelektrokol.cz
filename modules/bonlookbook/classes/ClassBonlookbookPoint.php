...
class ClassBonlookbookPoint extends ObjectModel
{
    public $id_sub;
    public $id_tab;
    public $id_shop;
    ...
    public static function getBonlookbookPointList($id_tab)
    {
        $sql = 'SELECT bonl.*
                FROM ' . _DB_PREFIX_ . 'bonlookbook_point bonl
                JOIN ' . _DB_PREFIX_ . 'bonlookbook_point_lang bonlb
    ...
    public static function getMaxSortOrder($id_tab)
    {
        $result = Db::getInstance()->ExecuteS('
            ...
            FROM `' . _DB_PREFIX_ . 'bonlookbook_point`
